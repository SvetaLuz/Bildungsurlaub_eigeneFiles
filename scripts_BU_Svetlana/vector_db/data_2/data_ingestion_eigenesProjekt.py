...
loader = DirectoryLoader(
    path=os.path.join(current_path, "data_2"),
...
splitter = RecursiveCharacterTextSplitter(chunk_size= 8000, chunk_overlap = 8000/5)
...
vectordb.save_local(folder_path="db_eigenesProjekt")
# %% testen
